...
namespace GroupByInc.RetailApi.Client.Model
{
    ...
    public partial class PriceInfo : IEquatable<PriceInfo>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PriceInfo);
        }

        /// <summary>
        /// Returns true if PriceInfo instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceInfo input)
        {
            if (input == null)
            {
                return false;
