...
namespace GroupByInc.RetailApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PriceInfo_PriceRange_price")]
    public partial class PriceInfoPriceRangePrice : IEquatable<PriceInfoPriceRangePrice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceInfoPriceRangePrice" /> class.
        /// </summary>
        ...
        public PriceInfoPriceRangePrice(double minimum = default(double), double exclusiveMinimum = default(double), double maximum = default(double), double exclusiveMaximum = default(double))
        {
        ...
        {
            return this.Equals(input as PriceInfoPriceRangePrice);
        }

        /// <summary>
        /// Returns true if PriceInfoPriceRangePrice instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceInfoPriceRangePrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceInfoPriceRangePrice input)
        {
            if (input == null)
            {
                return false;
