...
namespace GroupByInc.RetailApi.Client.Model
{
    ...
    public partial class SearchFilter : IEquatable<SearchFilter>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="SearchFilter" /> class.
        /// </summary>
        /// <param name="value">String to be appended to the search query. (required).</param>
        public SearchFilter(string value = default(string))
        {
            // to ensure "value" is required (not null)
            if (value == null)
            {
                throw new ArgumentNullException("value is a required property for SearchFilter and cannot be null");
            }
            this.Value = value;
        }
        ...
        /// </summary>
        /// <value>String to be appended to the search query.</value>
