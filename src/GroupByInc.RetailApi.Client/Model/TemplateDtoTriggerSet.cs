...
namespace GroupByInc.RetailApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateDto_triggerSet")]
    public partial class TemplateDtoTriggerSet : IEquatable<TemplateDtoTriggerSet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateDtoTriggerSet" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TemplateDtoTriggerSet() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateDtoTriggerSet" /> class.
        /// </summary>
        ...
        public TemplateDtoTriggerSet(List<QueryPatternTrigger> queryPatternTriggers = default(List<QueryPatternTrigger>), List<SelectedRefinementTrigger> selectedRefinementTriggers = default(List<SelectedRefinementTrigger>), List<CustomParameterTrigger> customParameterTriggers = default(List<CustomParameterTrigger>))
        {
            // to ensure "queryPatternTriggers" is required (not null)
            if (queryPatternTriggers == null)
            {
                throw new ArgumentNullException("queryPatternTriggers is a required property for TemplateDtoTriggerSet and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("selectedRefinementTriggers is a required property for TemplateDtoTriggerSet and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("customParameterTriggers is a required property for TemplateDtoTriggerSet and cannot be null");
            }
        ...
        {
            return this.Equals(input as TemplateDtoTriggerSet);
        }

        /// <summary>
        /// Returns true if TemplateDtoTriggerSet instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateDtoTriggerSet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateDtoTriggerSet input)
        {
            if (input == null)
            {
                return false;
