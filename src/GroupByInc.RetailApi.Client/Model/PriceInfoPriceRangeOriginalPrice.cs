...
namespace GroupByInc.RetailApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PriceInfo_PriceRange_originalPrice")]
    public partial class PriceInfoPriceRangeOriginalPrice : IEquatable<PriceInfoPriceRangeOriginalPrice>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PriceInfoPriceRangeOriginalPrice" /> class.
        /// </summary>
        ...
        public PriceInfoPriceRangeOriginalPrice(double minimum = default(double), double exclusiveMinimum = default(double), double maximum = default(double), double exclusiveMaximum = default(double))
        {
        ...
        {
            return this.Equals(input as PriceInfoPriceRangeOriginalPrice);
        }

        /// <summary>
        /// Returns true if PriceInfoPriceRangeOriginalPrice instances are equal
        /// </summary>
        /// <param name="input">Instance of PriceInfoPriceRangeOriginalPrice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PriceInfoPriceRangeOriginalPrice input)
        {
            if (input == null)
            {
                return false;
