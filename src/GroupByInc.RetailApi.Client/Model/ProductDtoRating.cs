...
namespace GroupByInc.RetailApi.Client.Model
{
    ...
    /// ProductDtoRating
    /// </summary>
    [DataContract(Name = "ProductDto_rating")]
    public partial class ProductDtoRating : IEquatable<ProductDtoRating>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductDtoRating" /> class.
        /// </summary>
        ...
        public ProductDtoRating(int ratingCount = default(int), float averageRating = default(float), List<int> ratingHistogram = default(List<int>))
        {
        ...
        {
            return this.Equals(input as ProductDtoRating);
        }

        /// <summary>
        /// Returns true if ProductDtoRating instances are equal
        /// </summary>
        /// <param name="input">Instance of ProductDtoRating to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProductDtoRating input)
        {
            if (input == null)
            {
                return false;
