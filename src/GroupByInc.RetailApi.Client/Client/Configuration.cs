...
namespace GroupByInc.RetailApi.Client.Client
{
    /// <summary>
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            {
                {
                    "AutocompleteApi.Autocompletesearch", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "ProductApi.GetByProductIds", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "RecommendationsAPIApi.Predict", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "RecommendationsAPIApi.PredictV2", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "SearchApi.FacetSearch", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
                ...
                {
                    "SearchApi.Search", new List<IReadOnlyDictionary<string, object>>
                    {
                        {
                            new Dictionary<string, object>
                            {
        ...
        {
            string report = "C# SDK (GroupByInc.RetailApi.Client) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 0.0\n";
